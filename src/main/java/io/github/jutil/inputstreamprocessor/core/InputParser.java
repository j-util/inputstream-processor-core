 ...
 *
 * <p>The input stream remains owned by the caller. Implementations must not close
 * it.</p>
 *
...
public interface InputParser<T> {
     ...
     *
     * <p>The emitter invokes the client consumer synchronously. If that consumer
     * propagates a runtime exception, the exception passes through this method
     * and processing terminates. Parser implementations may decide which of
     * their own recoverable failures to handle, but must not close
     * {@code input}.</p>
     *
